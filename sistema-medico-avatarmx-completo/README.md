...
# 🏥 Sistema Médico AvatarMX (Prototipo Funcional)
Este es un prototipo funcional de un sistema de consulta médica automatizada. Demuestra el flujo de conversación inicial y la integración entre un backend de FastAPI y un plugin de WordPress.
...
- **🔄 Flujo del Sistema**
  - ![Flujo del Sistema](URL_DEL_DIAGRAMA_DE_FLUJO)
...
1. Activar plugin `medico-avatarmx.zip`
2. Configurar en `Ajustes > AvatarMX Medical`
3. Crear productos con acceso médico
...
**AvatarMX Medical System - Transformando la salud through tecnología y sabiduría natural 🌿**
